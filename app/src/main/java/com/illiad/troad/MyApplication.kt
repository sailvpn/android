...
class MyApplication : Application(), ComponentCallbacks2 {
    ...
    override fun onLowMemory() {
        ...
        Log.e("MyApplication", "onLowMemory() called. This is serious!")
